  ...
  return (
    <section className="product">
      <div className="product__toBack">
          <button type="submit" className="product__toBack-button">
            <img
          ...
          <p className="product__toBack-label text-small">Back</p>
        </div>
      ...
      <div className="product__wrapper"> 
        ...
        <div className="product__form">
          <div className="product__form-label">
            <p className="product__form-label-color text-small">Available colors</p>
          ...
          <ul className="product__form-color">
            <li className="product__form-color-wrapper">
              <Link className="product__form-color-item product__form-color-item--pink" to="/"></Link>
            </li>
            <li className="product__form-color-wrapper">
              <Link className="product__form-color-item product__form-color-item--green" to="/"></Link>
            </li>
            <li className="product__form-color-wrapper">
              <Link className="product__form-color-item product__form-color-item--grey" to="/"></Link>
            </li>
            <li className="product__form-color-wrapper">
              <Link
          ...
          <p className="text-small product__form-capacity-label">Select capacity</p>
          <div
            className="product__form-capacity-btn"
          >
      ...
      <article className="product__info">
        ...
        <div className="product__specs-details">
          ...
          <p className="product__specs-value">12 Mp + 12 Mp + 12 Mp (Triple)</p>
        </div>
        <div className="product__specs-details">
