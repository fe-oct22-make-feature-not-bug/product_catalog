...
export const CartItem: React.FC<Props> = ({ phone, onQuantityIncrement, onQuantityDecrement }) => {
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-price">
        <div className="cart__item-price__counter">
          ...
          <button type="submit" className="cart__item-price__counter-minus" onClick={onQuantityDecrement}>
            <img src={minusItem} alt="minusItem" />
          </button>

          <p className="cart__item-price__counter-value">{phone.quantity}</p>

          <button type="submit" className="cart__item-price__counter-plus" onClick={onQuantityIncrement}>
            <img src={plusItem} alt="plusItem" />
          </button>
        </div>
        <h1 className="cart__item-price__value">${phone.price * phone.quantity}</h1>
      </div>
    </div>
  );
};
